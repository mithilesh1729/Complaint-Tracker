...
import HMCComplaintActions from "../../components/complaint/ComplaintActions/HMCComplaintActions";

import Skeleton from "../../components/common/Skeleton";
import ErrorState from "../../components/common/ErrorState";

function HMCComplaintDetails() {
  ...
  return (
    <div className="p-4" style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <PageHeader
        ...
        subtitle="View and manage escalated complaint."
      />
      ...
      <HMCComplaintActions complaint={complaint} refresh={fetchComplaint} />
    </div>
  );
}

export default HMCComplaintDetails;
